...
const rawRideData = require('./walibiData.js');
...
const sApiBase = Symbol('Walibi API Base URL');
const sCalendarURL = Symbol('Walivi Calendar URL');

/**
 * Implements the Walibi Park API
 * @class
 * @extends Park
 */
class Walibi extends Park {
  constructor(options = {}) {
    options.name = options.name || 'Walivi';
    ...
    this[sCalendarURL] = options.calendarURL || 'https://www.walibi.be/en/api/calendar/';
  }
